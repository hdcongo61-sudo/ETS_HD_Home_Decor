...
const stockReplacementReminderRoutes = require('./routes/stockReplacementReminderRoutes');
...
const cutoverRoutes = require('./routes/cutoverRoutes');
...
app.use('/api/proformas', protect, requireFeature(FEATURE_KEYS.PROFORMA), proformaRoutes);
app.use('/api/stock-replacement-reminders', stockReplacementReminderRoutes);
app.use('/api/employees', protect, requireFeature(FEATURE_KEYS.EMPLOYEES_PAYROLL), employeeRoutes);
app.use('/api/expenses', expenseRoutes);
app.use('/api/users', userRoutes);
app.use('/api/exports', protect, requireFeature(FEATURE_KEYS.DATA_EXPORT), exportRoutes);
app.use("/api/search", searchRoutes);
app.use('/api/export', pdfRoutes);
app.use('/api/notifications', notificationRoutes);
app.use('/api/bank', protect, requireFeature(FEATURE_KEYS.BANK), bankRoutes);
...
app.use('/api/v2', returnRoutes);
app.use('/api/v2', cashRoutes);
app.use('/api/v2', supplierRoutes);
app.use('/api/v2', purchaseRoutes);
app.use('/api/v2', shipmentRoutes);
app.use('/api/v2', supplierInvoiceRoutes);
app.use('/api/v2', replenishmentRoutes);
app.use('/api/v2', moduleRoutes);
app.use('/api/v2', reportRoutes);
app.use('/api/v2', importRoutes);
app.use('/api/v2', cutoverRoutes);
