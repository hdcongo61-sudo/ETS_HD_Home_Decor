                        ...
                        <div className="space-y-3">
                          ...
                          {auth.isAdmin && (
                            <>
                              ...
                              <div className="space-y-0.5">
                                <Link to="/ultimate-filters" className="block py-1.5 text-sm text-[var(--ms-blue)] hover:bg-[var(--ms-blue-soft)] rounded-md px-2 -mx-2 font-semibold" onClick={() => { closeMenu(); setAutresOpen(false); }}>✨ Filtres Ultimes</Link>
      ...
      {isMobile && hidePrimaryTabsOnMobile && (
        <div className="space-y-1">
          <MobileMenuSection title="Principal">
            ...
            {auth.isAdmin && <NavIcon to="/ultimate-filters" icon={<svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>} label="✨ Filtres Ultimes" className={`${linkClass} text-[var(--ms-blue)] font-semibold`} onClick={closeMenu} isMobile={isMobile} />}
