        ...
        return (
            <div className="p-4">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-2xl font-semibold text-[var(--ms-text-strong)]">Ressource introuvable</h1>
                </div>

                <div className="bg-[var(--ms-white)] rounded-lg border border-[var(--ms-border)] p-8 text-center shadow-[var(--ms-shadow-sm)]">
                    <div className="mb-6">
                        <div className="w-20 h-20 bg-[var(--ms-danger)]/15 rounded-full flex items-center justify-center">
                    ...
                    <h3 className="text-xl font-semibold text-[var(--ms-text-strong)] mb-2">
                        Bulletin introuvable
                    </h3>
                    <p className="text-[var(--ms-text)] mb-6 max-w-md">
    ...
    return (
        <div className="p-4">
            <div className="flex items-center mb-6">
                ...
                <h1 className="text-2xl font-semibold text-[var(--ms-text-strong)]">Modifier le bulletin</h1>
            </div>
                ...
                {employee && (
                    <div className="mb-6 p-4 bg-[var(--ms-bg-subtle)] rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <div className="text-xs text-[var(--ms-text-muted)]">ID du bulletin</div>
                                <div className="text-sm font-mono text-[var(--ms-text)]">{payslipId.substring(0, 8)}</div>
                            </div>
                        </div>
                    </div>
                )}
