# 🛍️ HD Gestion — Gérez toute votre boutique depuis votre téléphone

### Ventes • Stock • Clients • Caisse • Dépenses • Employés • Bénéfices — au même endroit.
...
✅ **Vous gardez le contrôle** — vos vendeurs vendent **sans voir vos marges** ; rien d'important ne se fait sans votre validation.
...
| 🧾 **Dépenses** | Suivi · catégories · objectif mensuel |
| 👷 **Employés** | Bulletins de paie · avances · salaires |
| 🆘 **Assistance** | Messagerie directe avec le support (suggestions, réclamations, questions) |
| 👑 **2 profils** | Administrateur (tout) & Vendeur (vend sans voir les marges) |

---

## Pourquoi HD Gestion ?

> **Voir clair. Perdre moins. Gagner du temps. Garder le contrôle.**

- 📱 **100 % mobile** — fonctionne sur téléphone, tablette et ordinateur, installable comme une vraie application.
- 🇫🇷 **En français, en francs CFA.**
- 🔒 **Sécurisé** — vos données protégées et isolées.
- 🎨 **À votre image** — logo, couleurs, nom de votre boutique.

---

### 📞 Intéressé(e) ? Contactez-nous pour une démonstration.
